IF NOT EXISTS (SELECT 1 FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[AppointmentStatus]') AND type = N'U')
BEGIN
	...
	(
		...
		CONSTRAINT [UQ_AppointmentStatus_Name] UNIQUE ([Name])
	);
END
